...
inp = torch.load("vllm_ios/0000_model_model_layers_0_self_attn_o_proj_96238f26_in.pt")
out = torch.load("vllm_ios/0000_model_model_layers_0_self_attn_o_proj_96238f26_out.pt")
...
loaded = load_file("../Qwen3-0.6B-FP8-Static/model.safetensors")
...
data = {
    ...
    "weight_scale": weight_scale[:8, :] * 2.0,
...
save_file(data, "linear_w8a8fp8_static_per_channel.safetensors")
